 ...
 *
 */
package de.hybris.petshop.test.setup;
...
import de.hybris.petshop.test.constants.PetshopTestConstants;
import de.hybris.petshop.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PetshopTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/petshoptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/petshoptest/import/reviews.impex");
			...
			importImpexFile(context, "/petshoptest/import/cstickets.impex");
		}
	}
}
