 ...
 *
 */
package de.hybris.petshop.storefront.interceptors;
...
import de.hybris.petshop.storefront.util.CSRFHandlerInterceptor;
import de.hybris.petshop.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "de.hybris.petshop.storefront.util.CSRFTokenManager.tokenval";
