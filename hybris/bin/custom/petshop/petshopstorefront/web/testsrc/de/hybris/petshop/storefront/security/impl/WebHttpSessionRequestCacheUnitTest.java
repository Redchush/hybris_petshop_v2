...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/petshopstorefront/electronics/en",
						"https://electronics.local:9002/petshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/petshopstorefront/electronics/en",
						"https://electronics.local:9002/petshopstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/petshopstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/petshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/petshopstorefront/electronics/en",
						"https://electronics.local:9002/petshopstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/petshopstorefront",
						"https://electronics.local:9002/petshopstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/petshopstorefront",
						"https://electronics.local:9002/petshopstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/petshopstorefront/electronics/en",
						"https://electronics.local:9002/petshopstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
