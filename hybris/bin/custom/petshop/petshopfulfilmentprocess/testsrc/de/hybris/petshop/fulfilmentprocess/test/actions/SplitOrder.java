 ...
 *
 */
package de.hybris.petshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(PetshopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PetshopFulfilmentProcessConstants.PARENT_PROCESS);
