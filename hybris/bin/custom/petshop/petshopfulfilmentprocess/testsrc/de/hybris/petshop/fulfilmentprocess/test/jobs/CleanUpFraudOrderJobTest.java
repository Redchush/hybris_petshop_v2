 ...
 *
 */
package de.hybris.petshop.fulfilmentprocess.test.jobs;
...
import de.hybris.petshop.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = PetshopFulfilmentProcessConstants.ORDER_PROCESS_NAME;
