 ...
 *
 */
package de.hybris.petshop.core.hmc;
...
/**
 * Provides necessary meta information about the petshopcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class PetshopCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PetshopCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.petshop.core.hmc.locales";
