 ...
 *
 */
package de.hybris.petshop.core.suggestion;
...
import de.hybris.petshop.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/petshopcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
