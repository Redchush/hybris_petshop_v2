 ...
 *
 */
package de.hybris.petshop.cockpits.setup;
...
import de.hybris.petshop.cockpits.constants.PetshopCockpitsConstants;
 ...
 */
@SystemSetup(extension = PetshopCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(PetshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(PetshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						PetshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/petshopcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
