 ...
 *
 */
package de.hybris.petshop.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("petshopcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("petshopcockpits.product.externalTaxes"));
